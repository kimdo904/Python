...
s = 'bext of best'
print(s.count('best',8))   # 10으로 하면 0이 나옴.
...
# find() 메소드는 찾는 문자열이 없는 경우 -1 반환. index() 메소드는 오류 발생
print()
s = 'apple'
print(s.index('p'))
# print(s.index('z'))
...
# capitalize : 첫 글자만 대문자로 변환하고 나머지는 소문자로 변환
...
# rstip() : 오른쪽 끝에 있는 불필요한 문자열을 제거한 결과를 반환
