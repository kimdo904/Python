...
# 2. 공백의 개수는 상관이 없음
# 3. 탭은 1개만 사용
# 4. 통일 구역에서 들여쓰기는 통일해야한다. 공백과 탭을 혼용하여 사용할 수 있고 들여쓰기 수준도 통일해야함.
...
# elif 조건식3:
#   조건식1의 결과가 False이고 조건식2의 결과도 False이고 조건식3의 결과가 True이면 실행된다.
# else:
#   조건식1,2,3의 결과가 모두 False이면 실행된다.
...
# 이렇게도 쓸 수 있으나 if-elif문 사용하기.(다중 if문)
# if score>=80:
#     print('상')
# else:   # 80점 미만이면
#     if score>=50:
