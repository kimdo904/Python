...
# 문자열 변환
# str() 함수를 사용하면 다른 자료형의 값을 문자열 데이터로 변환할 수 있다.
print(str(100)) # '100' / 정수 100을 문자열 '100'으로 변환
print(str(True)) # 'True' / 논리형 True를 문자열 'True'로 변환
print(str(False)) # 'False' / 논리형 False 문자열 'False'로 변환
...
# stop은 6으로 설정되어 있어 슬라이스는 문자열의 6번쨰 문자 바로 이전까지 가져온다.
# step은 2로 설정되어 있어 2칸씩 찍어낸다.
print(s[0:6:2]) # bnn
print(s[0:5:3]) # ba
