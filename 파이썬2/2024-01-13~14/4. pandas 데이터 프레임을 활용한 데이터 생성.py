...
# df['avg'] = (df['Math'] + df['English'] + df['Science']) / 4
print(df)
...
colums_list = ['A','B','C']
d3 = pd.DataFrame(data, index = index_date, columns= colums_list)
print(d3)

# 딕셔너리 타입으로 2차원 데이터를 입력한 예
table_data = {'연도' : [2015,2016,2017,2017],
              '지사' : ['한국','한국','미국','한국','일본'],
              '고객수' : [200,300,400,500,600]}
