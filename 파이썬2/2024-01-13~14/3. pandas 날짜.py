...
# 약어    설명  사용 예
# D      달력     기준 하루 주기 ex) 하루주기 : freq = 'D' 이틀주기 : freq = '2D'
...
# 연도의 첫날을 기준으로 1년 주기의 3개의 날짜를 생성
print(pd.date_range(start='2024-01-01', periods=4, freq='AS'))
...
# 30분 단위로 4개의 시간을 생성 (30min으로 설정해도 출력은 30T)
...
# df = pd.DataFrame(pd.date_range(start = '2024-01-01', periods=366, freq='D'))
# print(df)
