# 1. 객체의 개념
# 개발을 하다 보면 정수나 실수 또는 문자열 등 기본적인 자료형으로 표현하기 힘든 것들이 존재한다.
...
# 인스턴스는 instance 역시 클래스를 이용해서 생성한 객체를 가리키는 용어
...
# 5. 클래스 정의와 객체 생성
class WaffleMachine:    # WafflMachine 이라는 클래스 정의
    pass

waffle1 = WaffleMachine()   # WaffleMachine 이라는 클래스를 이용해 waffle이라는 객체 생성
waffle2 = WaffleMachine()

print(waffle1)  # <__main__.WaffleMachine object at 0x0000027A453BBB00> : 메모리에 0x0000027A453BBB00 번지에 저장된 WaffleMachine의 객체라는 의미
print(waffle2)
